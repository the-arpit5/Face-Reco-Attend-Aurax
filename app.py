...
with st.sidebar:
    ...
    col_s1.markdown(
        "<p style='color:#92fe9d; font-size:12px;'>● Engine: ON</p>",
        unsafe_allow_html=True
    )

    col_s2.markdown(
        "<p style='color:#00d2ff; font-size:12px;'>● DB: Sync</p>",
        unsafe_allow_html=True
    )
...
<p style="
    ...
    margin-top:-15px;
">
    Select a module from the sidebar or grid below
</p>
""", unsafe_allow_html=True)
...
<p style="
    ...
    font-size:12px;
">
    Aurex Attend Pro v2.1 | Security Protocol Alpha-9
</p>
""", unsafe_allow_html=True)
